...
argument-hint: "help | signup | email public|private | nickname <이름> | bio <소개> | role <직함> | company <회사> | city <도시> | link <종류> <url> | project add|list|main|remove|delete|clear | brief on|off | status | random | delete"
